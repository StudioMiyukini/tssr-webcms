...
const blocks: PageBlock[] = [
  ...
  note('gray', 'ℹ️ Nom de domaine — « prénom » = le vôtre', '<p>Dans le contexte, <strong>vous êtes embauché·e comme technicien réseau</strong> chez Engineer Aero. Le domaine <code>engineer&lt;prénom&gt;.lan</code> reprend <strong>votre propre prénom</strong> (celui du technicien recruté) — et <strong>non</strong> le prénom d’un des <strong>ingénieurs</strong> de la société (John, Rodney, Eliza…), qui n’ont rien à voir avec le nommage. Ici, pour « Jean » → <code>engineerjean.lan</code>. Remplacez <em>prénom</em> par le vôtre partout (zone DNS, noms de sites).</p>'),
