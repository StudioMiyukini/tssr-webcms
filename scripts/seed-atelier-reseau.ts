...
const blocks: PageBlock[] = [
  ...
  block('list', { listItems: [
    ...
    '④ Schéma & routeurs — diagramme de topologie (dorsale, switches, nuages LAN avec IP d’interfaces) + configuration CLI de chaque routeur (interfaces + routes statiques calculées automatiquement).',
