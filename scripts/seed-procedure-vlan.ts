...
ping <PC d'un autre VLAN>        ! ensuite l'autre VLAN`),
  ...
  note('green', '🔗 Pour aller plus loin', '<p>Théorie : <a href="/pages/les-vlan">Les VLAN &amp; le routage inter-VLAN</a>. Durcissement : <a href="/pages/vlan-securite">Sécuriser les VLAN</a>. À l’échelle : <a href="/pages/vlan-vtp">VTP</a>. Téléphonie : <a href="/pages/vlan-voix">Le VLAN voix</a>. Procédures voisines : <a href="/pages/procedure-cisco-routeur-cli">Configurer un routeur en CLI</a>, <a href="/pages/procedure-dhcp-relais">DHCP centralisé : serveur + relais</a>, <a href="/pages/procedure-atelier-reseau-az">Réseau multi-routeurs de A à Z</a>. Outil : <a href="/pages/atelier-reseau">Atelier Réseau</a>.</p>'),
];
