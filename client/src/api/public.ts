...
export interface HorsLigneDepot { url: string; taille: number }
export interface HorsLigneEtat { disponible: boolean; pret: boolean; taille: number; genereLe: string | null; url: string | null; exe: HorsLigneDepot | null }
